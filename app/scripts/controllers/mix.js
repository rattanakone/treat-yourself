...
angular.module('treatYourselfApp')
  .controller('MixCtrl', function ($scope, $sce, makeup, hair, outfit) {
    ...
    $scope.randomMakeupVideo = function () {
    	...
    	var embedMakeupCode = '<iframe ng-if="makeupVideoEmbed" width="420" height="315" src="https://www.youtube.com/embed/' + $scope.makeUpVideos.items[randomMakeupIndex].snippet.resourceId.videoId + '" frameborder="0" allowfullscreen></iframe>'; 
    ...
    $scope.randomHairVideo = function () {
        ...
        var embedHairCode = '<iframe ng-if="hairVideoEmbed" width="420" height="315" src="https://www.youtube.com/embed/' + $scope.hairVideos.items[randomHairIndex].snippet.resourceId.videoId + '" frameborder="0" allowfullscreen></iframe>'; 
    ...
    $scope.randomOutfitVideo = function () {
        ...
        var embedOutfitCode = '<iframe ng-if="outfitVideoEmbed" width="420" height="315" src="https://www.youtube.com/embed/' + $scope.outfitVideos.items[randomOutfitIndex].snippet.resourceId.videoId + '" frameborder="0" allowfullscreen></iframe>'; 
